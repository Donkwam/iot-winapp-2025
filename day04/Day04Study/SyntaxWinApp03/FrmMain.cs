...
namespace SyntaxWinApp03
{
    public partial class FrmMain : Form
    {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            DlgSave.Filter = "RTF파일 (*.rtf)|*.rtf|워드파일(*txt)|*.txt";
            DlgSave.Title = "RTF파일 저장";
        ...
        private void BtnLoad_Click(object sender, EventArgs e)
        {
            ...
            DlgOpen.Filter = "RTF파일 (*.rtf)|*.rtf|워드파일(*txt)|*.txt";
        ...
        private void BtnBold_Click(object sender, EventArgs e)
        {
            ...
            if (currentFont.Bold)
            {
                newStyle = currentFont.Style & FontStyle.Bold; // Bold 제거
            }
            else
            {
                newStyle = currentFont.Style | FontStyle.Bold; // Bold 추가
            }

            RtbNote.SelectionFont = new Font(currentFont, newStyle);
        }
    }
}
